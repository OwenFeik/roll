...
class Token:
    ...
    def __eq__(self, o: object) -> bool:
        return isinstance(o, Token) and o.token == self.token
...
class OpExpr(Expr):
    def __init__(
        self, opstr: str, left: Expr, right: Expr
    ) -> None:
        self.opstr = opstr
        self.left = left
        self.right = right
...
def parse(string: str):
    return parse_tokens(tokenize(string))[0] 

print(repr(parse("2d12 k3+4*(3 / 2)")))
